...
var JSONify = {};
JSONify.prototype = Object.create(CachingWriter.prototype);
JSONify.prototype.constructor = CachingWriter;
JSONify.prototype.updateCache = updateCache;
 ...
 * @param srcDir
 */
function objectify(srcDir) {
  var files = fixturify.readSync(srcDir);
...
module.exports = function(inputTree, options) {
  if (!(this instanceof JSONify)) return new JSONify(inputTree, options);
